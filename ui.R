...
#####################################################################                   
                    ...
                    conditionalPanel(
                        condition =  "input.Signature != 'Upload a Signature'",
                        downloadButton("ExampleFile", label = "Download Example Candidates File")
                    ),
                    conditionalPanel(
                        condition =  "input.Signature == 'Upload a Signature'",
                  ...
                  br(),
                   ...
                   conditionalPanel(condition="input.Advanced_button%2 ==  1 && input.Signature == 'Upload a Signature'",
                        #numericInput("topN", "Number of Analogs", value=1, min=1,max=5,step=1),
                        #selectInput("ILINCS", "iLINCS Version", list("Current", "Legacy"), selected="Current"),
                        selectInput("ConOrDiscon_2","Activation or Inhibition", list("Inhibit", "Activate"), selected="Inhibit"),            
                        conditionalPanel(condition="input.ConOrDiscon_2 == 'Inhibit'", numericInput("Concordance_2", "Concordance Threshold", value=0.1, min=0.1, max=0.3, step=0.1)),
                        conditionalPanel(condition="input.ConOrDiscon_2 == 'Activate'", numericInput("Concordance_3", "Discordance Threshold", value=-0.1, min=-0.5, max=-0.1, step=0.1))
                  ),  
